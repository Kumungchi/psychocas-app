...
> 📋 **Další kroky:** Jakmile schéma běží, ověřte přihlášení pro role member/manager/council/technician a přidejte předem schválené účty do tabulky `trusted_users`, aby se mohli přihlásit i bez hotového profilu v `members`.
